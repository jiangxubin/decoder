...
//    Model model;
    ...
    string map_path = "/home/augustus/Documents/decoder/decoder-cpp/data/ocr_char_set.txt";
    BeamSearch();
//    BeamSearch(string model_path);
    ...
    vector<string> beam_search_decoder(float *prob, int *index, int T, int K, int A);
