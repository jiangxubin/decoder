...
if __name__ == "__main__":
    ...
    consult_dict = {}
    with open("../data/yd2017_error/list.txt", 'r') as f:
        for line in f:
    ...
    lm_predcision_e = 0
    for root, dirnames, files in os.walk("../data/yd2017_error/nps"):
        for name in files:
    # for relative_dir in os.listdir("../data/yd2017_error/nps"):
